...
<div>
            ...
            <div class="row" data-aos="fade-up" data-aos-delay="200" data-aos-duration="1000">
                <div class="col-xl-4 m-b-30">
                    <div class="project-card style-service">
                        <div class="thumb">
                            <a href="services-details.webp"><img alt="thumb-63"
                                                                 src="assets/img/thumbs/thumb-63.webp"></a>
                            <div class="tag">
                                <p>No - 01</p>
                            </div>
                            <div class="content">
                                ...
                                <div class="join-us">
                                    <a class="e-primary-btn has-icon is-hover-white" href="services-details.webp">Read
                                        More <span class="icon-wrap"><span class="icon"><i
                ...
                <div class="col-xl-4 m-b-30">
                    <div class="project-card style-service">
                        <div class="thumb">
                            <a href="services-details.webp"><img alt="thumb-63"
                                                                 src="assets/img/thumbs/thumb-64.webp"></a>
                            <div class="tag">
                                <p>No - 02</p>
                            </div>
                            <div class="content">
                ...
                <div class="col-xl-4 m-b-30">
                    <div class="project-card style-service">
                        <div class="thumb">
                            <a href="services-details.webp"><img alt="thumb-63"
                                                                 src="assets/img/thumbs/thumb-65.webp"></a>
                            <div class="tag">
                                <p>No - 03</p>
                            </div>
                            <div class="content">
                ...
                <div class="col-xl-4 m-b-30">
                    <div class="project-card style-service">
                        <div class="thumb">
                            <a href="services-details.webp"><img alt="thumb-63"
                                                                 src="assets/img/thumbs/thumb-66.webp"></a>
                            <div class="tag">
                                <p>No - 04</p>
                            </div>
                            <div class="content">
                ...
                <div class="col-xl-4 m-b-30">
                    <div class="project-card style-service">
                        <div class="thumb">
                            <a href="services-details.webp"><img alt="thumb-63"
                                                                 src="assets/img/thumbs/thumb-67.webp"></a>
                            <div class="tag">
                                <p>No - 05</p>
                            </div>
                            <div class="content">
                ...
                <div class="col-xl-4 m-b-30">
                    <div class="project-card style-service">
                        <div class="thumb">
                            <a href="services-details.webp"><img alt="thumb-63"
                                                                 src="assets/img/thumbs/thumb-68.webp"></a>
                            <div class="tag">
                                <p>No - 06</p>
                            </div>
                            <div class="content">
    ...
    <section class="dust-recycling-section" style="background-image: url(assets/img/bg/dust-recycling-bg.webp)">
        <div class="container">
            <div class="row justify-content-center align-items-xl-start align-items-center">
                    ...
                    <div class="dust-recycle-card" data-aos="fade-up" data-aos-delay="200" data-aos-duration="1000">
                        ...
                        <div class="campaign-progress">
                            <div class="environmental">
                                ...
                                <div aria-label="Basic example" aria-valuemax="100" aria-valuemin="0" aria-valuenow="82"
                            ...
                            <div class="campaigns">
                                ...
                                <div aria-label="Basic example" aria-valuemax="100" aria-valuemin="0" aria-valuenow="94"
                                     class="progress" role="progressbar">
                ...
                <div class="col-2 order-1 order-lg-2 m-b-md-60 m-b-xs-60" data-aos="fade-up" data-aos-delay="400"
                     data-aos-duration="1000">
                    <div class="btn-layer">
    ...
    <!-- faq-section start -->
    <section class="faq-section style-service p-t-120 p-b-240"
             style="background-image: url(assets/img/bg/why-us-bg-3.html)">
        <div class="container">
            <div class="row faq">
                <div class="col-xl-5" data-aos="fade-up" data-aos-delay="200" data-aos-duration="1000">
                    ...
                    <div class="blog-btn">
                        <a class="e-primary-btn has-icon" href="contact.webp">Have You Any Questions? <span
                        ...
                        <div class="accordion-item">
                            <h2 class="accordion-header">
                                <button aria-controls="flush-collapseOne" aria-expanded="false"
                                        ...
                                        data-bs-toggle="collapse" type="button"><span class="accordion-title">1.</span>How
                                    do I get started? <span class="icon"><span class="icon-plus"></span> <span
                                            class="icon-minus"></span></span></button>
                            </h2>
                            <div class="accordion-collapse collapse" data-bs-parent="#accordionFlushExample"
                                 id="flush-collapseOne">
                                <div class="accordion-body">
                                    The point of using lorem ipsum is that has more-less packages normal commercial
                                    management in construction ensures the planning, execution and coordination.
                                </div>
                            </div>
                        </div>
                        <div class="accordion-item">
                            <h2 class="accordion-header">
                                <button aria-controls="flush-collapseTwo" aria-expanded="false"
                                        ...
                                        data-bs-toggle="collapse" type="button"><span class="accordion-title">2.</span>What
                                    fees do you charge? <span class="icon"><span class="icon-plus"></span> <span
                                            class="icon-minus"></span></span></button>
                            </h2>
                            <div class="accordion-collapse collapse" data-bs-parent="#accordionFlushExample"
                        ...
                        <div class="accordion-item">
                            <h2 class="accordion-header">
                                <button aria-controls="flush-collapseThree" aria-expanded="false"
                                        class="accordion-button" data-bs-target="#flush-collapseThree"
                                        data-bs-toggle="collapse" type="button"><span class="accordion-title">3.</span>Where
                                    should I incorporate my business? <span class="icon"><span class="icon-plus"></span> <span
                                            class="icon-minus"></span></span></button>
                            </h2>
                        ...
                        <div class="accordion-item">
                            <h2 class="accordion-header">
                                <button aria-controls="flush-collapseFour" aria-expanded="false"
                                        ...
                                        data-bs-toggle="collapse" type="button"><span class="accordion-title">4.</span>What
                                    type of company is measured? <span class="icon"><span
                        ...
                        <div class="accordion-item">
                            <h2 class="accordion-header">
                                <button aria-controls="flush-collapseFive" aria-expanded="false"
                                        ...
                                        data-bs-toggle="collapse" type="button"><span class="accordion-title">5.</span>How
                                    can I safely use files? <span class="icon"><span class="icon-plus"></span> <span
                                            class="icon-minus"></span></span></button>
                            </h2>
                            <div class="accordion-collapse collapse" data-bs-parent="#accordionFlushExample"
