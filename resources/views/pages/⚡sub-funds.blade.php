                            ...
                            <div class="d-cta-wrap">
                                <div class="content-wrap">
                                    <div class="common-title text-start">
                                        <h2>We Are Always Ready to Help You And Answer Your Questions
                                        </h2>
                                    </div>
                                    <div class="blog-btn">
                                        <a href="contact.webp" class="e-primary-btn has-icon">
                                ...
                                <div class="s-widget-wrap">
                                    <div class="detail-contact text-center">
                                        ...
                                        <div class="icon-info-wrap">
                                            <div class="icon-wrap">
                                                <div class="icon">
                                                    <img src="assets/img/icons/icon-18.webp" alt="icon">
                                                </div>
                                                <div class="bar-wrap">
                                                    <div class="bar-1"></div>
                                                    <div class="bar-2"></div>
